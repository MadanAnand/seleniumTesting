...
public class TestDataGenerator
{
    ...
    static String setPropDriver="webdriver.chrome.driver";
    static String setDriverPath="C:/Users/wEll/IdeaProjects/test-master/chromedriver.exe";
    static String uploadPath= "C:\\pixiLogo.png";
}
